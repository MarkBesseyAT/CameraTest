...
class OutputDeviceSource: NSObject, CMIOExtensionDeviceSource {
	
	private(set) var device: CMIOExtensionDevice!
	
	private var _streamSource: OutputStreamSource!
	...
	init(localizedName: String) {
		...
		_streamSource = OutputStreamSource(localizedName: "CameraTest.Video", streamID: videoID, streamFormat: videoStreamFormat, device: device)
		do {
...
class OutputStreamSource: NSObject, CMIOExtensionStreamSource {
	...
	func startStream() throws {
		...
		guard let deviceSource = device.source as? OutputDeviceSource else {
